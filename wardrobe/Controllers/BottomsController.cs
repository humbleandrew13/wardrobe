...
namespace wardrobe.Controllers
{
    public class BottomsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "BottomsID,BottomsNameDescription,PhotoLink,ColorPrimary,ColorSecondary,ColorTertiary,Season,Occasion")] Bottoms bottoms)
        {
